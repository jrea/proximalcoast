...
import { Baby, Flame, Skull, Lock } from "lucide-react";
...
export function HeatLevelSelector({ heatLevel, setHeatLevel, className, isTrial, onLockedClick }: HeatLevelSelectorProps) {
